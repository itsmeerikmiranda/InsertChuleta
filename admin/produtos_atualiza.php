...
if ($_FILES['imagemfile']['name']){ //Se o usuário escolher uma imagem
    ...
    $rand = rand (100001,999999); //Gera um número aleatório para diferenciar a imagem de outros usuários
                    ...
                    <label for="id_tipo">Tipo:</label>
                        ...
                        <div class="input-group">
                            <label for="destaque_s" class="radio-inline">
                                <input type="radio" name="destaque" id="destaque" value="Sim" <?php  ?> 
                            ...
                            <label for="destaque_n" class="radio-inline">
                                <input type="radio" name="destaque" id="destaque" value="Não" <?php  ?> 
